...
const AddRecipeForm = ({ editRecipeName, editRecipeDescription, setRecipeForm, setRecipeName, setRecipeDescription, setRecipeIngredients, recipeIngredients, submitFunction }) => {
